...
@registry.register_transform(display_name="Overlay Example", input_entity="maltego.Phrase",
                             description="Returns a Phrase with Overlays.",
...
class OverlayExample(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        entity: MaltegoEntity = response.addEntity(Phrase, f"Hi {person_name}, nice to meet you!")
