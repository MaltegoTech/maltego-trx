...
entity_property_map = {
        ...
        "maltego.URL":                 {"maltego.v2.value.property": "short-title", "theurl": "url",
                                        "fulltitle":                 "title"},
        "maltego.Document":            {"maltego.v2.value.property": "title", "link": "url",
                                        "metainfo":                  "document.meta-data"},
        "maltego.Location":            {"area": "location.area", "countrysc": "url", "long": "longitude",
                                        "lat":  "latitude"},
        "maltego.PhoneNumber":         {
        ...
        "maltego.affiliation.Spock":   {
                "network":        "affiliation.network", "uid": "affiliation.uid",
